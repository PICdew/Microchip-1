...
push    macro
        ...
        movwf StatusTemp                         ; Save STATUS in StatusTemp in common memory.
        endm
pop     macro
        swapf StatusTemp,W                       ; Swap StatusTemp register into W

        movwf STATUS                             ; Copy W into STATUS (Sets bank to original state)
...
; Timer 1 Setup
        movlw 0X00
        banksel TMR1H
        movwf TMR1H                              ;Timer= 0000-FFFFH = 65535*8/(8M/4) = 0.26214s Prescale = 4
        movlw 0X00
        banksel TMR1L
        movwf TMR1L
